"""Pure synthesis logic shared by the Phase 3 EXR performance gate and its tests."""
...
def synthesize_gate_decision(initial: GateRun, repeat: GateRun | None = None) -> GateDecision:
    """Apply the Phase 3 0.95 threshold, repeat band, and read-candidate tie-break."""
...
def assert_gate_decisions_match_source_selection(
    ...
    if synthesized_selection != expected_selection:
        raise AssertionError(
            "source-fixed Phase 3 selection does not match synthesized gate decisions: "
